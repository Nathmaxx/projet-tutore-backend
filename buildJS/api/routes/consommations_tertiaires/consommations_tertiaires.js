...
const helpers_1 = require("../../models/consommations_tertiaires/helpers");
...
router.get("/", checkBearerToken_1.checkBearerToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const parcelles = yield helpers_1.ConsommationsTertiairesHelper.getConsommationsTertiaires();
...
router.get("/:id", checkBearerToken_1.checkBearerToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const parcelle = yield helpers_1.ConsommationsTertiairesHelper.getConsommationTertiairesById(id);
...
router.get("/annee/:annee", checkBearerToken_1.checkBearerToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const parcelles = yield helpers_1.ConsommationsTertiairesHelper.getConsommationsTertiairesByAnnee(annee);
...
router.get("/commune/:commune/annee/:annee", checkBearerToken_1.checkBearerToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const parcelles = yield helpers_1.ConsommationsTertiairesHelper.getConsommationsTertiairesByCommuneAndAnnee(commune, annee);
    if (!parcelles || parcelles.length === 0) {
